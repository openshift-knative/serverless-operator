...
replace (
	...
	knative.dev/eventing => github.com/cardil/eventing v0.11.1-0.20210609102549-481a26fd9454
	knative.dev/eventing-kafka => github.com/cardil/eventing-kafka v0.21.1-0.20210609130636-52e5100c8a0b
