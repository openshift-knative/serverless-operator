...
require (
	...
	knative.dev/caching v0.0.0-20220118175933-0c1cc094a7f4 // indirect
...
replace (
	...
	// Knative forks.
	knative.dev/eventing => github.com/openshift/knative-eventing v0.99.1-0.20220331152436-2d719a259f3a
	knative.dev/eventing-kafka => github.com/openshift-knative/eventing-kafka v0.19.1-0.20220331132250-f5f8ed8b4a98
	knative.dev/eventing-kafka-broker => github.com/openshift-knative/eventing-kafka-broker v0.25.1-0.20220401141337-a97f556151b4
	knative.dev/serving => github.com/openshift/knative-serving v0.10.1-0.20220401053154-e6900621cde7
)
