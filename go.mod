...
require (
	...
	knative.dev/operator v0.37.5-0.20231002134039-d2e39067b426
...
replace (
	...
	knative.dev/serving => github.com/openshift-knative/serving v0.10.1-0.20230913105533-08434dbf32cd
)
