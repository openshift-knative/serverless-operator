...
replace (
	...
	knative.dev/eventing => github.com/cardil/eventing v0.11.1-0.20210525135852-116524fc7b9f
	knative.dev/eventing-kafka => github.com/cardil/eventing-kafka v0.21.1-0.20210525161113-e17d14cc6e79
