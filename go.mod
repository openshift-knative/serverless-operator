...
replace (
	// Knative forks.
	knative.dev/eventing => github.com/openshift/knative-eventing v0.99.1-0.20221103140936-42624ea2302f
	knative.dev/eventing-kafka => github.com/openshift-knative/eventing-kafka v0.19.1-0.20221109100552-26eea5293bca
	knative.dev/eventing-kafka-broker => github.com/openshift-knative/eventing-kafka-broker v0.25.1-0.20221109114908-65d7a94559c7
	knative.dev/serving => github.com/openshift/knative-serving v0.10.1-0.20221104041031-904fbb42eeaf
)
...
replace knative.dev/pkg => knative.dev/pkg v0.0.0-20220705130606-e60d250dc637
