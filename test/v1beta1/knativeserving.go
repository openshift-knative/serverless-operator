...
func WaitForKnativeServingStateAlpha(ctx *test.Context, name, namespace string, inState ServingInStateFuncAlpha) (*operatorv1alpha1.KnativeServing, error) {
	var (
...
type ServingInStateFuncAlpha func(s *operatorv1alpha1.KnativeServing, err error) (bool, error)
...
func IsKnativeServingWithVersionReadyAlpha(version string) ServingInStateFuncAlpha {
