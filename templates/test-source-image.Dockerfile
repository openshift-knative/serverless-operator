...
COPY --from=registry.ci.openshift.org/openshift/__EVENTING_KAFKA_SRC_IMAGE__ /go/src/github.com/openshift-knative/eventing-kafka-broker/ /go/src/knative.dev/eventing-kafka-broker/
