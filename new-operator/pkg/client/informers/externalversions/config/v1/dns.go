...
import (
	...
	v1 "github.com/openshift-knative/serverless-operator/new-operator/pkg/client/listers/config/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1().DNSs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1().DNSs().Watch(context.TODO(), options)
			},
		},
		&configv1.DNS{},
		resyncPeriod,
