...
import (
	...
	client "github.com/openshift-knative/serverless-operator/pkg/client/config/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/openshift/client-go/config/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
