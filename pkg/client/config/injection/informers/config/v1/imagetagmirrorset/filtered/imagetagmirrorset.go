...
func Get(ctx context.Context, selector string) v1.ImageTagMirrorSetInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/openshift/client-go/config/informers/externalversions/config/v1.ImageTagMirrorSetInformer with selector %s from context.", selector)
	}
