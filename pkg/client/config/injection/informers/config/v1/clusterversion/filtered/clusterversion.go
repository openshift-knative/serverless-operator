...
func Get(ctx context.Context, selector string) v1.ClusterVersionInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/openshift/client-go/config/informers/externalversions/config/v1.ClusterVersionInformer with selector %s from context.", selector)
	}
