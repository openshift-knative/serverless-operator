...
import (
	...
	commoneventing "github.com/openshift-knative/serverless-operator/knative-operator/pkg/common/eventing"
...
var log = commoneventing.Log.WithName("controller")
...
func (r *ReconcileKnativeEventing) configure(instance *eventingv1alpha1.KnativeEventing) error {
	...
	if err := commoneventing.MutateEventing(instance, r.client); err != nil {
		return err
	}
