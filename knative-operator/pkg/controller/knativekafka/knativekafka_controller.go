...
func add(mgr manager.Manager, r *ReconcileKnativeKafka) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(), client.Object(&operatorv1beta1.KnativeEventing{}), filteredGlobalResync(context.Background(), mgr.GetLogger(), r, func(_ client.Object) bool {
		return true
	})))
	if err != nil {
		return err
