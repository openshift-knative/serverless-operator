...
import (
	"context"
	"fmt"
	common "github.com/openshift-knative/serverless-operator/knative-operator/pkg/common/eventing"
	"net/http"
	"os"
...
func (v *KnativeEventingValidator) Handle(ctx context.Context, req types.Request) types.Response {
	ks := &eventingv1alpha1.KnativeEventing{}
...
func (v *KnativeEventingValidator) validate(ctx context.Context, ks *eventingv1alpha1.KnativeEventing) (allowed bool, reason string, err error) {
...
func (v *KnativeEventingValidator) validateVersion(ctx context.Context, ks *eventingv1alpha1.KnativeEventing) (bool, string, error) {
...
func (v *KnativeEventingValidator) validateNamespace(ctx context.Context, ks *eventingv1alpha1.KnativeEventing) (bool, string, error) {
