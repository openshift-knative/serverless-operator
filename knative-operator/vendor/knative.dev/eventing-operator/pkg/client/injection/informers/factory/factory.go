...
import (
	...
	externalversions "knative.dev/eventing-operator/pkg/client/informers/externalversions"
	client "knative.dev/eventing-operator/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-operator/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
