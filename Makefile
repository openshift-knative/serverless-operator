...
install: install-tool-sobranch install-tool-sorhel
	./hack/install.sh

install-operator: install-tool-sobranch install-tool-sorhel
	INSTALL_SERVING="false" INSTALL_EVENTING="false" ./hack/install.sh

install-all: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	./hack/tracing.sh
	SCALE_UP=4 INSTALL_KAFKA="true" ENABLE_TRACING=true ./hack/install.sh

install-release-next: install-tool-sobranch install-tool-sorhel generated-files-release-next
...
install-serving: install-tool-sobranch install-tool-sorhel
	INSTALL_EVENTING="false" ./hack/install.sh

install-serving-with-mesh: install-tool-sobranch install-tool-sorhel
	UNINSTALL_MESH="false" ./hack/mesh.sh
	MESH=true SCALE_UP=4 INSTALL_SERVING=true INSTALL_EVENTING="false" ./hack/install.sh

install-eventing: install-tool-sobranch install-tool-sorhel
	INSTALL_SERVING="false" ./hack/install.sh

install-kafka: install-tool-sobranch install-tool-sorhel
	SCALE_UP=4 INSTALL_SERVING="false" INSTALL_KAFKA="true" ./hack/install.sh

install-kafka-with-mesh: install-tool-sobranch install-tool-sorhel
	UNINSTALL_MESH="false" ./hack/mesh.sh
...
install-kafka-with-keda: install-tool-sobranch install-tool-sorhel
...
install-previous: install-tool-sobranch install-tool-sorhel
	INSTALL_PREVIOUS_VERSION="true" ./hack/install.sh

install-previous-with-kafka: install-tool-sobranch install-tool-sorhel
...
test-e2e: install-tool-sobranch install-tool-sorhel
	./hack/tracing.sh
...
operator-e2e: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	./hack/tracing.sh
	SCALE_UP=4 INSTALL_KAFKA="true" ENABLE_TRACING=true ./hack/install.sh
	TEST_KNATIVE_KAFKA=true ./test/e2e-tests.sh
...
operator-e2e-no-tracing: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
...
test-e2e-with-mesh: install-tool-sobranch install-tool-sorhel
	UNINSTALL_MESH="false" ./hack/mesh.sh
	./hack/tracing.sh
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
...
test-upstream-e2e-mesh-testonly: install-tool-sobranch
	MESH=true TEST_KNATIVE_KAFKA=true ./test/e2e-tests.sh
...
upstream-e2e: install-tool-sobranch install-tool-sorhel
	TRACING_BACKEND=zipkin ./hack/tracing.sh
...
upstream-e2e-kafka: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	TRACING_BACKEND=zipkin ./hack/tracing.sh
...
test-upgrade: install-tool-sobranch install-tool-sorhel
...
mesh-upgrade: install-tool-sobranch install-tool-sorhel
	UNINSTALL_MESH=false ./hack/mesh.sh
	TRACING_BACKEND=zipkin ./hack/tracing.sh
	UNINSTALL_STRIMZI=false ./hack/strimzi.sh
...
kitchensink-upgrade: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	./hack/dev.sh
...
test-kitchensink-upgrade-stress: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI=false ./hack/strimzi.sh
...
ui-e2e: install-tool-sobranch install-tool-sorhel
	./hack/install.sh
	./test/ui-e2e-tests.sh
...
test-kitchensink-e2e-setup: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	SCALE_UP=4 INSTALL_KAFKA="true" ./hack/install.sh

# Runs all subsets of kitchensink tests. Runs tests separately so `go test` doesn't take too much memory in CI
kitchensink-e2e: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
...
test-soak: install-tool-sobranch install-tool-sorhel
	UNINSTALL_STRIMZI="false" ./hack/strimzi.sh
	SCALE_UP=6 INSTALL_KAFKA="true" ./hack/install.sh
	./test/soak-tests.sh

# Run all E2E tests.
test-all-e2e: install-tool-sobranch install-tool-sorhel
	./hack/tracing.sh
	ENABLE_TRACING=true ./hack/install.sh
	./test/e2e-tests.sh
