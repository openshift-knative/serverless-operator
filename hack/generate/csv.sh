...
image "eventing-controller__kube-rbac-proxy"    "$rbac_proxy"
image "sugar-controller__controller"                "${eventing}-sugar-controller"
image "sugar-controller__kube-rbac-proxy"               "$rbac_proxy"
image "eventing-webhook__eventing-webhook"          "${eventing}-webhook"
image "eventing-webhook__kube-rbac-proxy"          "$rbac_proxy"
...
image "mt-broker-controller__kube-rbac-proxy"  "$rbac_proxy"
image "mt-broker-filter__filter"                    "${eventing}-mtbroker-filter"
image "mt-broker-filter__kube-rbac-proxy"                    "$rbac_proxy"
image "mt-broker-ingress__ingress"                  "${eventing}-mtbroker-ingress"
image "mt-broker-ingress__kube-rbac-proxy"                  "$rbac_proxy"
image "imc-controller__controller"                  "${eventing}-channel-controller"
image "imc-controller__kube-rbac-proxy"                 "$rbac_proxy"
image "imc-dispatcher__dispatcher"                  "${eventing}-channel-dispatcher"
image "imc-dispatcher__kube-rbac-proxy"                  "$rbac_proxy"
