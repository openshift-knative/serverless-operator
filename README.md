...
- `make uninstall-strimzi`: Uninstall the Strimzi operator and any existing kafka cluster instance. 
...
- `make test-upgrade`: Installs a `previous` version of Serverless and
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for details on how to contribute, including
linting, release process, and the Developer Certificate of Origin (DCO).
